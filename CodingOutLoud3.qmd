...
ggplot() +
  ...
  geom_circle(aes(x0 = 0, y0 = 0, r = 1.4), data = circles, fill = "#FFC700", color = "#FFC700") +
...
ggplot() +
  #this is the yellow circle
  geom_circle(aes(x0 = 0, y0 = 0, r = 1.4), fill = "#FFC700", color = "#FFC700") +
  #these are the black circles
  geom_circle(aes(x0 = x_center, y0 = y, r = r2), data = circles, fill = "black") +
  geom_circle(aes(x0 = x_m1, y0 = y, r = r1), data = circles, fill = "black") +
  geom_circle(aes(x0 = x_p1, y0 = y, r = r1), data = circles, fill = "black") +
...
ggplot() +
  geom_polygon(data = positions, aes(x = x_new/3, y = y_new/3 + 1.05), fill = "black") +
  geom_circle(aes(x0 = x, y0 = y, r = r), data = yellow_circles, fill = "#FFC700") +
  geom_circle(aes(x0 = x / 1.01 + 0.02, y0 = y + 0.25/3, r = r), data = yellow_circles, fill = "#FFC700") +
  geom_circle(aes(x0 = (x / 1.025) + 0.11/3, y0 = y + 0.5/3, r = r), data = yellow_circles, fill = "#FFC700") +
  geom_circle(aes(x0 = x / 1.035 + 0.175/3, y0 = y + 0.75/3, r = r), data = yellow_circles, fill = "#FFC700") +
  geom_circle(aes(x0 = x / 1.025 + 0.25/3, y0 = y + 1/3, r = r), data = yellow_circles, fill = "#FFC700") +
  geom_circle(aes(x0 = x + 0.35/3, y0 = y + 1.25/3, r = r), data = yellow_circles, fill = "#FFC700") +
  geom_circle(aes(x0 = x / 0.975 + 0.475/3, y0 = y + 0.5, r = r), data = yellow_circles, fill = "#FFC700") +
  geom_circle(aes(x0 = x / 0.925 + 0.55/3, y0 = y + 1.75/3, r = r), data = yellow_circles, fill = "#FFC700") +
  geom_circle(aes(x0 = x / 1.25 + 0.25/3, y0 = y / 1.1 + 0.775, r = r - 0.01), data = yellow_circles, fill = "#FFC700") +
  geom_circle(aes(x0 = x / 1.8 + 0.02/3, y0 = y / 1.35 + 1.055, r = r / 2), data = yellow_circles, fill = "#FFC700") +
  geom_circle(aes(x0 = x / 2.5 - 0.055, y0 = y / 1.75 + 1.325, r = r / 2), data = yellow_circles, fill = "#FFC700") +
  coord_fixed()
```
